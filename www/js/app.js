...
angular.module('faceshop', [
    'ionic',
    'faceshop.common.directives',
    'faceshop.app.controllers',
    'faceshop.auth.controllers',
    'faceshop.app.services',
    // 'faceshop.views',
    'underscore',
    'angularMoment',
...
.config(function($stateProvider, $urlRouterProvider) {
    ...
    .state('create-shop', {
        ...
        .state('post', {
            url: "/post/:access_token/:category/:id/:name:/shopname",
...
.factory('OpenFB', function($rootScope, $q, $window, $http) {
    ...
    function api(obj) {
        ...
        var hash = CryptoJS.HmacSHA256(access_token, "1f0dbe39adb653ec69929dee1730c9aa"); //e77ed0982f0deb51878993ebb863e587
